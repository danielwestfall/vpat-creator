...
export function EmailDialog({ project, results, onClose }: EmailDialogProps) {
  ...
  const notTested = results.filter(r => (r.conformance as string) === 'Not Tested' || !r.conformance).length;
        ...
        <div className="email-dialog__body">
          <div className="email-dialog__note">
            ...
            <p>
              ...
              <strong> You must manually attach the exported PDF or JSON file</strong> to the email before sending.
            </p>
          </div>
          ...
          <div className="email-dialog__preview">
            ...
            <div className="email-dialog__preview-content">
              {generateBody()}
            </div>
